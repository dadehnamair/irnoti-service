{{--
    ...
    sections; every link keeps its Route::has() guard and is-active logic.
    Icons are hand-written inline SVGs — the public side has no icon set.
--}}
<nav class="account-nav" aria-label="ناوبری پنل کاربری">
    <div class="account-nav__group">
        <span class="account-nav__label">حساب کاربری</span>
    ...
    <div class="account-nav__group">
        <span class="account-nav__label">پیامک</span>
    ...
    <div class="account-nav__group">
        <span class="account-nav__label">مالی</span>
