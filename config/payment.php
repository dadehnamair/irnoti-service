...
return [
    ...
    |
    */
    // irnoti: driver is chosen with PAYMENT_DRIVER in .env. The bundled "local"
    // driver is a test gateway (no credentials needed) — switch to zarinpal /
    // saman / … and fill its merchantId once a real gateway is contracted.
    ...
    */
    'drivers' => [
        'local' => [
            'callbackUrl' => '/lines/payment/callback',
        ...
        'zarinpal' => [
            ...
            'callbackUrl' => env('APP_URL', 'http://localhost').'/lines/payment/callback',
